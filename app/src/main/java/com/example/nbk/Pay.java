...
//        }
        ...
        confirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Bitmap myBitmap = QRCode.from(backend.UserPaymentLink(UID, customer.FirstName, customer.LastName, Float.parseFloat(value))).bitmap();
